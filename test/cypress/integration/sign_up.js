describe('Rails Sign Up Create', function() {
    it("Create a new user", function() {
        ...
        cy.get("[name='user[username]']").type("alex11"); // select username field and type in leah
        cy.get("[name='user[email]']").type("hsx_124+11@hotmail.com"); // select email field and type in email
