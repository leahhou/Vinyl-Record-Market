Rails.application.routes.draw do
  ...
  # post "/favorite_listings", to: "favorite_listings#create", as: "create_favorite_listing"
  # delete "favorite_listings", to: "favorite_listings#destroy", as: "delete_favorite_listing"
