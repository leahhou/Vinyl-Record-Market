...
*LO-FI Wire-Frames*
![Sign in page](.docs/images/lo_fi_wire_frame/1.%Sign%In%.png)
![Home page](.docs/images/lo_fi_wire_frame/2.%Home.png)
![Home stretch goal](.docs/images/lo_fi_wire_frame/2.1%Home(Stretch).png)
...
*DESKTOP MOCKUP*
![home](.docs/images/hi_fi_wire_frame/Home_hi-fi%2.png)
